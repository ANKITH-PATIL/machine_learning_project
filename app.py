    ...
    if os.path.isfile(abs_path):
        if ".html" in abs_path:
            with open(abs_path, "r", encoding="utf-8") as file:
                ...
                return content
        return send_file(abs_path) # send files sends the files to our systems (or allows download after clicking)
...
def saved_models_dir(req_path):
    ...
    # Check if path is a file and serve
    if os.path.isfile(abs_path):
        return send_file(abs_path) # send files allows to download the file
